...
TICKER_CONFIG = {
    "^GSPC": {"name": "S&P 500", "short": "SPX", "type": "Index", "on_map": True, "lat": 37.09, "lon": -95.71, "country": "USA"},
    "^IXIC": {"name": "Nasdaq", "short": "NDX", "type": "Index", "on_map": True, "lat": 40.71, "lon": -74.00, "country": "USA"},
    "^DJI":  {"name": "Dow Jones", "short": "DJI", "type": "Index", "on_map": True, "lat": 34.05, "lon": -118.24, "country": "USA"}, # LA offset from NYC
    ...
    "S68.SI": {"name": "SGX", "short": "SGX", "type": "Index", "on_map": True, "lat": 4.35, "lon": 103.81, "country": "Singapore"},
